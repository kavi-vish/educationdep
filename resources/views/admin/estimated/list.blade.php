...
<div class="flex">
    ...
    <div class="flex-grow-1 p-4" style="min-height: 100vh; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="container-fluid">
            ...
            <div class="card border-0 mb-4" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1);">
                <div class="card-header border-0 d-flex justify-content-between align-items-center py-4" style="background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); border-radius: 16px 16px 0 0;">
                    <h4 class="mb-0 text-white fw-bold text-center">
                        <i class="fas fa-file-invoice-dollar me-2 "></i> All Estimated Budgets
                    </h4>
            ...
            <!-- Budgets Table Card -->
            <div class="card border-2" style="background: rgba(255, 255, 255, 0.98); backdrop-filter: blur(10px); border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); overflow: hidden;">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 " style="border-collapse: separate; border-spacing: 20;">
                            <thead style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%); border-bottom: 2px solid #2563eb;">
                                <tr>
                                    <th class="py-4 ps-4" style="color: #1e40af; font-weight: 600; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.5px;">--No</th>
                                    ...
                                    <th class="py-4" style="color: #1e40af; font-weight: 600; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.5px;">Total</th>
                                ...
                                @forelse($budgets as $budget)
                                    <tr style="transition: all 0.3s ease; border-bottom: 1px solid #e5e7eb;">
                                        ...
                                        <td class="py-4 align-middle">
                                            <div class="d-flex align-items-center">
                                                <div class="rounded-circle d-flex align-items-center justify-content-center me-2" 
                                                    ...
                                                    {{ strtoupper(substr($budget->user?->name ?? 'U', 0, 1)) }}
                                                </div>
                                                <strong style="color: #1e293b; font-weight: 600;">{{ $budget->user?->name ?? 'N/A' }}</strong>
                                            </div>
                                        </td>
                                        <td class="py-4 align-middle">
                                            <span class="badge" style="background: linear-gradient(135deg, #ffffffff 0%, #ffffffff 100%); border-radius: 8px; padding: 6px 12px; font-size: 0.813rem; font-weight: 500;">
                                                {{ $budget->zone }}
                                            </span>
                                        </td>
                                        <td class="py-4 align-middle" style="color: #475569; max-width: 250px;">
                                            <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $budget->subject }}">
                                                {{ Str::limit($budget->subject, 30) }}
                                            </div>
                                        </td>
                                        <td class="py-4 align-middle">
                                            <span class="badge" style="background: linear-gradient(135deg, #ffffffff 0%, #ffffffff 100%); border-radius: 8px; padding: 6px 12px; font-size: 0.813rem; font-weight: 500;">
                                                {{ $budget->activity_code }}
                                            </span>
                                        </td>
                                        <td class="py-4 align-middle">
                                            <strong style="color: #059669; font-weight: 700; font-size: 1rem;">
                                        ...
                                        <td class="py-4 pe-4 align-middle">
                                            <a href="{{ route('admin.estimated.show', $budget->id) }}" 
                                               class="btn btn-sm" 
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center py-5">
                                            <div class="py-5">
                                                ...
                                                <h5 style="color: #64748b; font-weight: 600;">No Budgets Found</h5>
                                                <p style="color: #94a3b8; font-size: 0.875rem;">There are no estimated budgets to display at the moment.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
